...
<head>
    ...
    <style>
        body {
            background-color: #d1e7ff; /* Bleu plus prononcé pour l'arrière-plan */
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
        }

        .container {
            background-color: #0056b3; /* Bleu plus intense pour le conteneur */
        ...
        .list-group-item {
            background-color: #f7faff; /* Bleu très clair pour chaque notification */
            border: none;
            border-radius: 12px;
            margin-bottom: 10px;
            padding: 15px 20px;
            ...
            color: #0056b3; /* Bleu pour le texte */
        }

        .list-group-item:hover {
            background-color: #d1e7ff; /* Effet de survol avec bleu léger */

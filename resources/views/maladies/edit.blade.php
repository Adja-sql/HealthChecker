...
<head>
    ...
    <title>Modifier une Maladie</title>
...
<body>
    <div class="container">
        <h1 class="text-center">Modifier une Maladie</h1>
        <form action="{{ route('maladies.update', $maladie->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="description" name="description" rows="4" required>{{ $maladie->description }}</textarea>
            </div>
